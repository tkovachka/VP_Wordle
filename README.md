...
### 2.3 Настани со кои се справува формата со прикажување на порака со MessageBox 
...
## Класа GuessedWord 
- чува колкупати се појавува секоја буква во дадените зборови - public GuessedWord(string letter,int count)
